DROP TABLE DEPT0979 CASCADE CONSTRAINTS;
DROP TABLE EMP0979 CASCADE CONSTRAINTS;

CREATE TABLE DEPT0979 (
	DEPTNO NUMBER(2) PRIMARY KEY,
	DNAME VARCHAR2(14),
	LOC VARCHAR2(13),
	MANAGER NUMBER(4)  -- 부서 관리자 사원번호 추가 
);

CREATE TABLE EMP0979 (
	...
	SAL NUMBER(7,2),
	COMM NUMBER(7,2),
	DEPTNO NUMBER(2) REFERENCES DEPT0979(DEPTNO)
);

INSERT INTO DEPT0979 VALUES
...
ALTER TABLE DEPT0979 ADD CONSTRAINT FK_DEPT0979 
	FOREIGN KEY(MANAGER) REFERENCES EMP0979(EMPNO);
